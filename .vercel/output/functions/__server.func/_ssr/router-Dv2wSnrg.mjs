...
import { $t as runWithTransaction, B as string, C as runWithEndpointContext, D as toResponse, E as serializeSignedCookie, F as looseObject, Gt as ATTR_HOOK_TYPE, I as number, J as jwtVerify, Jt as safeJSONParse, K as decodeJwt, Kt as ATTR_OPERATION_ID, L as object, M as array, N as boolean, O as filterOutputFields, P as email, Qt as runWithAdapter, R as optional, S as getCurrentAuthContext, T as serializeCookie, Ut as withSpan, W as base64Url, Wt as ATTR_CONTEXT, Xt as getCurrentAdapter, Yt as getAuthTables, Zt as queueAfterTransactionHook, _ as createAuthMiddleware, _n as kAPIErrorHeaderSymbol, _t as encode, a as betterFetch, an as createLogger, b as hasRequestState, c as applyDefaultAccessTokenExpiry, d as findInvalidTrustedProxies, en as getBetterAuthVersion, f as getIp, fn as isDevelopment, g as createAuthEndpoint, gn as BetterAuthError, h as normalizePathname, hn as APIError, i as refreshAccessToken, in as createRandomStringGenerator, j as any, kt as JWTExpired, l as isLoopbackHost, ln as env, mn as isTest, n as socialProviders, nn as initGetFieldName, on as logger, p as deprecate, pn as isProduction, q as decodeProtectedHeader, qt as import_src, r as validateAuthorizationCode, rn as generateId, s as createAuthorizationURL, sn as shouldPublishLog, t as SocialProviderListEnum, tn as initGetModelName, u as createRateLimitKey, v as isAPIError, vn as BASE_ERROR_CODES, w as createRouter$1, x as runWithRequestState, y as defineRequestState, yn as defineErrorCodes, z as record } from "../_libs/@better-auth/core+[...].mjs";
import { L as require_react, f as createRouter, g as createRootRoute, h as createFileRoute, l as Scripts, m as lazyRouteComponent, p as Outlet, u as HeadContent, v as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dv2wSnrg.js
...
function applyTheme(theme) {
	...
	if (meta) meta.setAttribute("content", theme === "dark" ? "#0c0b0a" : "#f6f3ee");
}
...
var styles_default = "/assets/styles-DePecd8c.css";
var APP_NAME = "Maya Chen · Links";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Maya Chen — product designer & photographer. Portfolio, photos, newsletter, and more."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-D9kMbPg6.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-B4YZxemr.mjs");
...
//#endregion
export { getBaseURL as a, PACKAGE_VERSION as i, GROK_PROVIDERS as n, useTheme as o, GENERIC_OAUTH_ERROR_CODES as r, router_exports as t };
