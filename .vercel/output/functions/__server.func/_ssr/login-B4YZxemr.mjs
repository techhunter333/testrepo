...
import { Bt as capitalizeFirstLetter, Vt as toKebabCase, m as isSafeUrlScheme, o as createFetch } from "../_libs/@better-auth/core+[...].mjs";
import { L as require_react, _ as Link, v as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { n as defu } from "../_libs/defu.mjs";
import { a as getBaseURL, i as PACKAGE_VERSION, n as GROK_PROVIDERS, r as GENERIC_OAUTH_ERROR_CODES } from "./router-Dv2wSnrg.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { i as atom, n as onMount, r as onSet, t as listenKeys } from "../_libs/nanostores.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-B4YZxemr.js
...
function Login() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		className: "grid min-h-dvh place-items-center px-5 py-12 pt-[calc(var(--grok-banner-h,0px)+3rem)]",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-full max-w-sm rounded-2xl border border-border bg-bg-elevated p-6 shadow-soft sm:p-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-6 space-y-1.5 text-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "font-display text-2xl font-medium tracking-tight text-fg",
						children: "Sign in"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-fg-muted",
						children: "Access your account to manage links."
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: GROK_PROVIDERS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("flex w-full items-center justify-center rounded-xl border border-border-strong", "bg-bg px-4 py-3 text-sm font-semibold text-fg", "transition-[transform,background-color,border-color] duration-fast ease-[var(--ease-smooth)]", "hover:bg-bg-subtle active:scale-[0.98]", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"),
